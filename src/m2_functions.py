...
def turtle5():
    carson = rg.SimpleTurtle('turtle')
    phil = rg.SimpleTurtle('turtle')

    carson.pen = rg.Pen('blue',25)
    carson.speed = 5
    carson.right(55)
    carson.forward(300)
    carson.begin_fill()
    carson.draw_circle(150)
    carson.end_fill()

    phil.pen = rg.Pen('yellow',12)
    phil.speed = 12
    phil.left(38)
    phil.backward(200)
    phil.begin_fill()
    phil.draw_regular_polygon(8,100)
    phil.end_fill()
