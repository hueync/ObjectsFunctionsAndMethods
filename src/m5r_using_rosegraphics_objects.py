...
#            Updates all shapes in the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When a window has been initialized or it will not stay open.
#
